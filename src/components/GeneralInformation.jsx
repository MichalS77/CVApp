...
const handleStatus = (e) =>{
 ...
 return(<div>
  ...
  <p style={{ display: status === 'editing' ? 'none' : 'inline'}}>Name: {name}</p>
  <label style={{ display: status === 'submitted' ? 'none' : 'inline-block'}} >Name:
  <input name="nameValue"/>
  </label>
  <br/>
  <p style={{ display: status === 'editing' ? 'none' : 'inline'}}>E-mail: {email}</p>
  <label style={{ display: status === 'submitted' ? 'none' : 'inline-block'}} >E-mail:
  <input name="emailValue"/>
  </label>
  <br/>
  <p style={{ display: status === 'editing' ? 'none' : 'inline'}}>Address: {address}</p>
  <label style={{ display: status === 'submitted' ? 'none' : 'inline-block'}} >Address:
